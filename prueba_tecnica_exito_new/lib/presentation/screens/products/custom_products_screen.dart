...
/// Pantalla de productos personalizada con interfaz mejorada
/// Vista avanzada con inputs editables para gestionar cantidades
class CustomProductsScreen extends StatefulWidget {
  final String category;
  
  const CustomProductsScreen({super.key, required this.category});

  @override
  State<CustomProductsScreen> createState() => _CustomProductsScreenState();
}
          ...
          body: Column(
            children: [
              ...
              Container(
                ...
                child: Text(
                  "${widget.category.toUpperCase()} Custom",
                  style: const TextStyle(
                    fontSize: 18,
