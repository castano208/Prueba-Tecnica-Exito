...
import '../../../widgets/extra/inputPersonalizado.dart';

class PantallaProductosModificada extends StatefulWidget {
  final String categoria;
  const PantallaProductosModificada({super.key, required this.categoria});

  @override
  State<PantallaProductosModificada> createState() => _PantallaProductosEstado();
}

class _PantallaProductosEstado extends State<PantallaProductosModificada> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: Text(
            widget.categoria.toUpperCase() + " Personalizado",
            style: TextStyle(
              color: Colors.black,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          InputPersonalizado(
                            ...
                            modoExpressActivo: express.modoExpressActivo,
                          ),
                        ],
                      ),
                    ),
